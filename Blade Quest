...
wait (60)
	...
	game:GetService("TeleportService"):Teleport(920587237, plr);
	-- note: this pretty much overrides and cancels the teleport (the anticheat teleports you back to lobby)
	wait (60)
-- [[ START OF SETTINGS ]]
Distance = 6 -- TP Distance from enemy
BrokenServerTimer = 360 -- Seconds. Will leave the level if a new enemy doesn't spawn within this timeframe
Speed = 250 -- TP Speed, lower if you get teleported back to the lobby before finishing the level
